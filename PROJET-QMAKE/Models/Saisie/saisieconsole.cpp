#include "Models/Saisie/saisieconsole.h"
#include <iostream>
#include <limits>
#include <map>
#include <regex>
...
TypesJeu SaisieConsole::demanderTypeDeJeu()
{
...
int SaisieConsole::demanderModeDeJeu()
{
    int modeJeu;
    bool choixValide;
    do
...
bool SaisieConsole::demanderRejouer()
{
    std::string choix;
    bool choixValide;
    do
...
std::string SaisieConsole::demanderPrenomJoueur(const std::string &prompt)
{
    std::string prenom;
...
std::pair<int, int> SaisieConsole::demanderCordonnee()
{
    int x, y;
...
int SaisieConsole::demanderColonne()
{
    int colonne;
